...
namespace EventApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            Response.Redirect("https://accounts.google.com/o/oauth2/v2/auth?client_id=868360967766-16m02f3h7j62d42jhbl3pkpmia124740.apps.googleusercontent.com&response_type=code&scope=openid%20email%20profile&redirect_uri=http://3.136.161.174//GoogleSignIn&state=abcdef");
        }
        ...
        public async Task<ActionResult> GoogleSignIn(string code, string state, string session_state)
        {
            ...
            var requestUrl = $"oauth2/v4/token?code={code}&client_id=868360967766-16m02f3h7j62d42jhbl3pkpmia124740.apps.googleusercontent.com&client_secret=FHMvE9-Hc6ZOh9H0Af3oCiLQ&redirect_uri=http://3.136.161.174//GoogleSignIn&grant_type=authorization_code";  
